...
class HomeController extends Controller
{
    ...
    public function index(){
        $ordersToday = $this->orderService->getOrderByDate(['from'=> now(),'to'=> now()])->where('type','ordre');
        $purchasesToday = $this->purchaseService->getPurchaseByDate(['from'=> now(),'to'=> now()])->where('type','purchase');
