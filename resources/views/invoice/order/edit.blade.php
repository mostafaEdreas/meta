                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 mt-3 justify-content-between">
                        ...
                        <input class="form-control form-control-lg" name="reference" type="text" readonly
                            value="{{ $order->reference }}" aria-label="default input example">
                    </div>
                    <div class="col-sm-12 col-md-4 mt-3 justify-content-between">
                    ...
                    <div class="col-sm-12 col-md-4 mt-3 justify-content-between">
                        ...
                        <select class="form-select form-select-lg " id="discount_type_invoice" name="discount_type"
                            ...
                            <option value="percent" {{ $order->discount_type == 'percent' ? 'selected' : '' }}>نسبه مئوية
                            </option>
                        </select>
                    </div>
                    <div class="col-sm-12 col-md-4 mt-3 justify-content-between">
                    ...
                    <tbody id="tbodyOrder">
                        ...
                        @foreach ($order->products as $key => $value)
                            <tr id="r{{ $num }}">
                                ...
                                <td><input type="text" name="price[]" value="{{ $value->pivot->price }}"
                                        class="price form-control form-control-lg"></td>
                                <td><input type="text" name="quantity[]"
                                        value="{{ $value->pivot->quantity }}"class="quantity form-control form-control-lg">
                                </td>
                                <td><input type="text" value="{{ $value->pivot->discount_p }}"
